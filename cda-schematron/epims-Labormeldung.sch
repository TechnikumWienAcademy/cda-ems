...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: Labormeldung - Labormeldung (2.16.840.1.113883.2.16.777.3.4.4)</title>
   ...
   <!-- Include the project schematrons related to scenario Labormeldung -->

<!-- epims_document_labormeldung -->
    <pattern>
        <title>epims_document_labormeldung</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.2.40.0.34.11.1'] and hl7:templateId[@root = '1.2.40.0.34.11.6'] and hl7:templateId[@root = '1.2.40.0.34.11.6.0.1']]" see="http://art-decor.org/art-decor/decor-templates--epims-?id=1.2.40.0.34.11.6.0.1">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '1.2.40.0.34.11.1'] and hl7:templateId[@root = '1.2.40.0.34.11.6'] and hl7:templateId[@root = '1.2.40.0.34.11.6.0.1']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
